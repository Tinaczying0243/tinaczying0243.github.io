...
export const works: WorkItem[] = [
  ...
  {
    id: "fulbright",
    title: "Berkeley and Beyond: Fulbright Scholars Question Around the World",
    outlet: "UC Berkeley Graduate School of Journalism",
    date: "May 2025",
    description:
      "A multimedia story investigating how the U.S. government's abrupt suspension of Fulbright funding threw international scholars into financial and emotional limbo — forcing them to choose between their research dreams and financial survival.",
    url: "https://readymag.website/u1929452997/5452467/",
    tags: ["Multimedia", "Higher Education", "Immigration Policy", "UC Berkeley"],
    category: "multimedia",
    featured: true,
  ...
  },
  {
    ...
    date: "2025",
    description:
      "An interactive data journalism piece examining the sweeping economic consequences of mass deportation policy, featuring original data visualizations of immigrant labor contributions across industries.",
    url: "https://edisonyzwu.github.io/interactive/",
    tags: ["Data Visualization", "Immigration", "Economics", "Interactive"],
    category: "multimedia",
    featured: true,
  ...
  // WRITING — TECH / BUSINESS
  {
    ...
    date: "2025",
    description:
      "An investigation into how leading California universities responded to federal funding uncertainty and budget pressures with hiring freezes and layoffs — and what it means for students and staff.",
    url: "https://drive.google.com/file/d/1C6biPR1V30PgwA_iECd-teMtfbBezuT3/view?usp=sharing",
    tags: ["Higher Education", "Economy", "California", "Business"],
  ...
  },
  {
    ...
    date: "July 22, 2025",
    description:
      "How a viral toy craze originating in Asia is spawning a wave of Bay Area entrepreneurs: custom resellers, collectors, and artists turning pop-culture passion into profit.",
    url: "https://www.mercurynews.com/2025/07/22/labubu-craze-creativity-bay-area-businesses/",
    tags: ["Pop Culture", "Small Business", "Bay Area", "Tech Culture"],
    category: "writing-tech",
    type: "Feature",
  },
  {
    ...
    date: "2025",
    description:
      "A data-driven look at the branding and marketing strategy behind the new WNBA franchise's mascot, compared across the league's teams.",
    url: "https://drive.google.com/file/d/1cSsvAb9s_L3xdoGLQIvz7OczUh2n9Z0l/view?usp=sharing",
    tags: ["Sports Business", "WNBA", "Branding", "Bay Area"],
    category: "writing-tech",
    type: "Feature",
  },
  ...
  // WRITING — LOCAL NEWS
  {
    ...
    date: "November 2024",
    description:
      "Real-time reporting covering candidates' campaigns, ballot measures, and breaking results across San Francisco on Election Night 2024.",
    url: "https://missionlocal.org/2024/11/election-2024-live-updates-from-across-san-francisco-november-races/",
    tags: ["Elections", "San Francisco", "Local Politics", "Live Coverage"],
  ...
  },
  {
    ...
    description:
      "A profile of the beloved Oakland independent bookstore's journey from devastating fire to triumphant reopening — and what it means for the local literary community.",
    url: "https://oaklandnorth.net/2024/12/16/oakland-east-bay-booksellers-reopens-after-fire/",
    tags: ["Oakland", "Local Business", "Community", "Culture"],
    category: "writing-local",
    featured: true,
    type: "Feature",
  },
  {
    ...
    date: "August 22, 2025",
    description:
      "A practical, expert-sourced guide for Bay Area residents on identifying local snake species, understanding behavior, and what to do in an unexpected encounter.",
    url: "https://www.eastbaytimes.com/2025/08/22/snakes-bay-area-what-to-do/",
    tags: ["Bay Area", "Nature", "Public Safety", "Local News"],
    category: "writing-local",
    type: "Explainer",
  },
];
